import { getCanonicalCommunityAddress } from '@bitsocial/bitsocial-react-hooks/dist/lib/community-address.js';
...
export const getDisplayAddress = (address?: string | null): string => (address ? getCanonicalCommunityAddress(address) : '');
